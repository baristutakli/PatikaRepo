...
for (let i = 0; i < categories.length; i++) {
  ...
  btn.style.backgroundColor =  "#2E4053"
...
function koreanFoods() {
  ...
  menu.map((food) => {
    if (food.category == "Korea") {
      ...
      liDom.innerHTML = creatCard(food) 
      menuContainer.append(liDom)
...
function creatCard(food) {
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item">Origin: ${food.category}</li>
